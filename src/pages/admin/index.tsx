...
export const Stores = () => <div className="p-6"><h1 className="text-2xl font-bold">إدارة المتاجر</h1><p className="text-muted-foreground mt-2">قريباً...</p></div>;
export const Products = () => <div className="p-6"><h1 className="text-2xl font-bold">إدارة المنتجات</h1><p className="text-muted-foreground mt-2">قريباً...</p></div>;
export const Offers = () => <div className="p-6"><h1 className="text-2xl font-bold">إدارة العروض</h1><p className="text-muted-foreground mt-2">قريباً...</p></div>;
...
export const Roles = () => <div className="p-6"><h1 className="text-2xl font-bold">صلاحيات الأدمن</h1><p className="text-muted-foreground mt-2">قريباً...</p></div>;
